...
url = 'https://api.bilibili.com/x/v1/dm/list.so?oid=203589945'    #弹幕api,通过直接在视频链接"bilibili"前加入“i”获取
dic = {
...
for index in data_list:
    with open('雷军.txt',mode='a',encoding='utf-8') as f:
        f.write(index)
        f.write('\n')

f = open('雷军.txt',encoding='utf-8')
text = f.read()
...
wc = wordcloud.WordCloud(
    ...
    mask=img2 ,
    stopwords={'开始','的','地方','了','你','我','啊','同学','小米'},
    font_path = 'msyh.ttc',
)
wc.generate(cuttext)
wc.to_file('雷军词云.png')
